	...
	<body>
		<div class="container">
			<header>
				...
				<p class="subtitle">Upload or paste .cfg scenario files to extract and organize story content, character dialogues, and scenario information from Wesnoth campaigns</p>
			</header>
			...
			<section class="input-section">
				<div class="input-options">
					<div class="input-option active" data-target="upload">
						<h3>Upload Files</h3>
						<p>Select one or multiple .cfg scenario files from your computer</p>
					</div>
					<div class="input-option" data-target="paste">
						<h3>Paste Content</h3>
				...
				<div class="input-content active" id="upload-content">
					...
					<div class="controls">
						<button class="btn" id="process-btn">Extract Story Content</button>
				...
				<div class="input-content" id="paste-content">
					...
					<div class="controls">
						<button class="btn" id="paste-process-btn">Extract Story Content</button>
						<button class="btn btn-secondary" id="paste-reset-btn">Clear</button>
					</div>
				</div>
			</section>
